...
message = tk.Label(window, text="Face-Recognition", bg="black", fg="white", width=50,
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black",  height=2, font=('times', 15, 'italic bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, fg="red")
txt2.place(x=550, y=310)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white", bg="black"  ,width=15  ,height=3, activebackground = "Red" ,font=('times', 20, 'italic bold '))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Train Images",fg="white",command=trainimg ,bg="black"  ,width=15  ,height=3, activebackground = "Red",font=('times', 20, 'italic bold '))
